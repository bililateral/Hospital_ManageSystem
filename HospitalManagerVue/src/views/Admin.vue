        ...
        <el-container>
            ...
            <el-aside width="200px">
                ...
                <el-menu background-color="white" text-color="grey" active-text-color="black"
                    ...
                    <el-menu-item index="dataExpore" @click="menuClick('dataExpore')" style="font-size: 20px">
                        <i class="iconfont icon-r-mark1" style="font-size: 26px">
                        </i>
                        数据统计分析
                    </el-menu-item>
                </el-menu>
...
import { toLoad } from "@/utils/initialize.js"; //@表示"src/",即项目源代码根目录
