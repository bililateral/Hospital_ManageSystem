...
public class DrugServiceImpl implements DrugService {
    ...
    public Boolean addDrug(Drug drug){
        //如果账号已存在则返回false
        if (this.drugMapper.selectById(drug.getDrId())!=null)
            return false;
        return this.drugMapper.insert(drug) > 0;
    }
    /**
     * 删除药物信息
     */
    @Override
    public Boolean deleteDrug(int drId) {return this.drugMapper.deleteById(drId) > 0;}
    /**
     * 修改药物信息
     */
    @Override
