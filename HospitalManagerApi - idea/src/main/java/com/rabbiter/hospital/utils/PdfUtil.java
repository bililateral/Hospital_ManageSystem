...
public class PdfUtil {
    ...
    public static void ExportPdf(HttpServletRequest request, HttpServletResponse response, Orders order, double registrationFee) throws Exception {
        //告诉浏览器用什么软件可以打开此文件
        response.setHeader("content-Type", "application/pdf");
        // 生成并设置动态文件名
        String fileName = "医院病情报告单_" + order.getPatient().getPName() + "_" + order.getOId() + ".pdf";
        ...
        PdfPCell cell3 = new PdfPCell(new Paragraph("挂号费",new Font(bfChinese, 14, Font.NORMAL)));
        cell3.setFixedHeight(25);
        cell3.setBorder(0);
        PdfPCell cell4 = new PdfPCell(new Paragraph(String.valueOf(registrationFee)+"元", new Font(bfChinese, 10, Font.NORMAL)));
        cell4.setFixedHeight(30);
        cell4.setBorder(0);
        cell4.setPaddingLeft(10);
        PdfPCell cell5 = new PdfPCell(new Paragraph("检查项目及价钱", new Font(bfChinese, 14, Font.NORMAL)));
        cell5.setFixedHeight(25);
        cell5.setBorder(0);
        PdfPCell cell6 = new PdfPCell(new Paragraph(order.getOCheck(), new Font(bfChinese, 10, Font.NORMAL)));
        cell6.setFixedHeight(30);
        cell6.setBorder(0);
        cell6.setPaddingLeft(10);
        PdfPCell cell7 = new PdfPCell(new Paragraph("药物及价钱", new Font(bfChinese, 14, Font.NORMAL)));
        cell7.setFixedHeight(25);
        cell7.setBorder(0);
        PdfPCell cell8 = new PdfPCell(new Paragraph(order.getODrug(), new Font(bfChinese, 10, Font.NORMAL)));
        cell8.setFixedHeight(30);
        cell8.setBorder(0);
        cell8.setPaddingLeft(10);
        PdfPCell cell9 = new PdfPCell(new Paragraph("诊断/医生意见", new Font(bfChinese, 14, Font.NORMAL)));
        cell9.setFixedHeight(25);
        cell9.setBorder(0);
        PdfPCell cell10 = new PdfPCell(new Paragraph(order.getOAdvice(), new Font(bfChinese, 10, Font.NORMAL)));
        ...
        tableOrder.addCell(cell9);
        tableOrder.addCell(cell10);
